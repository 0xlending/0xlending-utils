...
interface I0xLendingIncentivesControllerV2Interface extends ethers.utils.Interface {
  functions: {
...
export class I0xLendingIncentivesControllerV2 extends BaseContract {
  ...
  interface: I0xLendingIncentivesControllerV2Interface;
